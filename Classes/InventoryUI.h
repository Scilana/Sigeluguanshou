...
class InventoryUI : public cocos2d::Layer {
 public:
  ...
  static InventoryUI* create(InventoryManager* inventory,
                             MarketState* marketState = nullptr);
   ...
   */
  void setPartnerInventory(InventoryManager* partner,
                           bool isShippingBin = false) {
  ...
  typedef std::function<void(int slotIndex, ItemType type, int count)>
      ItemSelectCallback;
