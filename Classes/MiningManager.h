...
class MiningManager : public cocos2d::Node {
 public:
   ...
   */
  static MiningManager* create(MineLayer* mineLayer,
 ...
 private:
  ...
  std::unordered_map<long long, MineralProgress>
      activeMinings_;  // 正在挖掘的矿物
   ...
   * @brief 掉落物品
   */
  std::string dropItems(const cocos2d::Vec2& tileCoord,
