...
bool InventoryManager::addItem(ItemType itemType, int count) {
  if (itemType == ItemType::ITEM_NONE || count <= 0) return false;
...
int InventoryManager::getItemCount(ItemType itemType) const {
  ...
  for (const auto& slot : slots_) {
    if (slot.type == itemType) total += slot.count;
  }
  return total;
}

const InventoryManager::ItemSlot& InventoryManager::getSlot(
    int slotIndex) const {
...
void InventoryManager::setSlotData(int slotIndex, ItemType itemType, int count,
...
void InventoryManager::swapSlots(int index1, int index2) {
  if (index1 < 0 || index1 >= static_cast<int>(slots_.size()) || index2 < 0 ||
      index2 >= static_cast<int>(slots_.size()))
    return;
...
void InventoryManager::addMoney(int amount) { money_ += amount; }
...
bool InventoryManager::repairSlot(int slotIndex) {
  ...
  auto& slot = slots_[slotIndex];
  if (slot.isEmpty() || !slot.isTool()) return false;
...
int InventoryManager::findItemSlot(ItemType itemType) const {
  for (int i = 0; i < static_cast<int>(slots_.size()); ++i) {
    if (slots_[i].type == itemType) return i;
  }
  return -1;
}
...
std::string InventoryManager::getItemDescription(ItemType itemType) {
  switch (itemType) {
    case ItemType::Hoe:
      return "Tills soil for planting";
    case ItemType::WateringCan:
      return "Waters crops";
    case ItemType::Scythe:
      return "Harvests mature crops";
    case ItemType::Axe:
      return "Chops down trees";
    case ItemType::Pickaxe:
      return "Mines rocks";
    case ItemType::FishingRod:
      return "Catches fish";
    case ItemType::SeedTurnip:
      return "Grows into turnip";
    case ItemType::SeedPotato:
      return "Grows into potato";
    case ItemType::SeedCorn:
      return "Grows into corn";
    case ItemType::SeedTomato:
      return "Grows into tomato";
    case ItemType::SeedPumpkin:
      return "Grows into pumpkin";
    case ItemType::SeedBlueberry:
      return "Grows into blueberry";
    case ItemType::Wood:
    ...
    case ItemType::Tomato:
      return "Fresh tomato";
    case ItemType::Pumpkin:
      return "Fresh pumpkin";
    case ItemType::Blueberry:
      return "Fresh blueberry";
    case ItemType::Fish:
      return "Fresh fish";
      // 矿石
    case ItemType::CopperOre:
      return "Common ore, worth 50 gold";
    case ItemType::IronOre:
      return "Sturdy ore, worth 100 gold";
    case ItemType::SilverOre:
      return "Valuable ore, worth 150 gold";
    case ItemType::GoldOre:
      return "Precious ore, worth 500 gold";
    case ItemType::DiamondOre:
      return "Rare gem, worth 1000 gold";
    // 武器
    case ItemType::ITEM_WoodenSword:
      return "Basic sword, 10 attack";
    case ItemType::ITEM_IronSword:
      return "Sturdy sword, 25 attack";
    case ItemType::ITEM_GoldSword:
      return "Elegant sword, 40 attack";
    case ItemType::ITEM_DiamondSword:
      return "Legendary sword, 60 attack";
      // 鱼类
    case ItemType::ITEM_Anchovy:
      return "A small saltwater fish.";
    case ItemType::ITEM_Carp:
      return "A common pond fish.";
    case ItemType::ITEM_Eel:
      return "A long, slippery fish.";
    case ItemType::ITEM_Flounder:
      return "A flat sea fish.";
    case ItemType::ITEM_Largemouth_Bass:
      return "A popular freshwater game fish.";
    case ItemType::ITEM_Pufferfish:
      return "Can inflate itself when threatened.";
    case ItemType::ITEM_Rainbow_Trout:
      return "A colorful freshwater fish.";
    case ItemType::ITEM_Sturgeon:
      return "An ancient, valuable fish.";
    case ItemType::ITEM_Tilapia:
      return "A common tropical fish.";
    default:
      return "";
  }
}
...
std::string InventoryManager::getItemIconPath(ItemType itemType) {
  switch (itemType) {
    case ItemType::Hoe:
      return "tools/hoe.png";
    case ItemType::WateringCan:
      return "tools/kettle.png";
    case ItemType::Scythe:
      return "tools/scythe.png";
    case ItemType::Axe:
      return "tools/axe.png";
    case ItemType::Pickaxe:
      return "tools/pickaxe.png";
    case ItemType::Fish:
      return "tools/fish.png";
      // 鱼类
    case ItemType::ITEM_Anchovy:
      return "fish/Anchovy.png";
    case ItemType::ITEM_Carp:
      return "fish/Carp.png";
    case ItemType::ITEM_Eel:
      return "fish/Eel.png";
    case ItemType::ITEM_Flounder:
      return "fish/Flounder.png";
    case ItemType::ITEM_Largemouth_Bass:
      return "fish/Largemouth_Bass.png";
    case ItemType::ITEM_Pufferfish:
      return "fish/Pufferfish.png";
    case ItemType::ITEM_Rainbow_Trout:
      return "fish/Rainbow_Trout.png";
    case ItemType::ITEM_Sturgeon:
      return "fish/Sturgeon.png";
    case ItemType::ITEM_Tilapia:
      return "fish/Tilapia.png";
    case ItemType::CopperOre:
      return "ore/Bixite.png";
    case ItemType::IronOre:
      return "ore/Kyanite.png";
    case ItemType::SilverOre:
      return "ore/Marble.png";
    case ItemType::GoldOre:
      return "ore/Fire_Quartz.png";
    case ItemType::DiamondOre:
      return "ore/Diamond.png";
    case ItemType::FishingRod:
      return "tools/fishingRod.png";
    case ItemType::SeedTurnip:
      return "tools/carrotSeed.png";
    case ItemType::SeedPotato:
      return "tools/dogbaneSeed.png";
    case ItemType::SeedCorn:
      return "tools/cornSeed.png";
    case ItemType::SeedTomato:
      return "tools/carrotSeed.png";
    case ItemType::SeedPumpkin:
      return "tools/dogbaneSeed.png";
...
bool InventoryManager::isStackable(ItemType itemType) {
  ...
  // 武器不可堆叠
  if (itemType == ItemType::ITEM_WoodenSword ||
      itemType == ItemType::ITEM_IronSword ||
      itemType == ItemType::ITEM_GoldSword ||
      itemType == ItemType::ITEM_DiamondSword) {
    return false;
  }
...
int InventoryManager::getMaxStack(ItemType itemType) {
  // 工具只能1个
  if (!isStackable(itemType)) return 1;
